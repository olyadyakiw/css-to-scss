...
( function ( $ ) {
   ...
   $.fn.roundForms.select = function () {
       ...
       if ( !this.hasClass( "initialized" ) )
       {
           ...
           this.find( " > .block .icon, > .block .selection" ).on( "click", function ( e ) {
               ...
               {
                   $( ".round__form-field.select.active" ).removeClass( config.openMenuClass ).removeClass( "active" );
               }
           ...
           this.find( ".menu .item" ).on( "click", function ( e ) {
               ...
               var root = $(this).closest( ".round-forms__field.select" );
   ...
   $.fn.roundForms.input = function () {
       ...
       if ( !this.hasClass( "initialized" ) )
       {
           ...
           this.find( "input" ).on( "focus blur keyup", function ( e ) {
               ...
               var root = $(this).closest( ".round-forms__field.input" );
   ...
   $.fn.roundForms.textarea = function () {
       ...
       if ( !this.hasClass( "initialized" ) )
       {
           ...
           this.find( ".round-forms__overflow > textarea" ).on( "focus blur keyup", function ( e ) {
               ...
               var root = $(this).closest( ".round-forms__field.textarea" );
   ...
   $.fn.roundForms.upload = function () {
       ...
       if ( !this.hasClass( "initialized" ) )
       {
           ...
           this.find( ".icon, .text" ).on( "click", function ( e ) {
               ...
               $(this).closest( ".round-forms__field.upload" ).find( "input[type=file]" ).click();
   ...
   $( "body" ).click( function( e ) {
       ...
       {
           $( ".round-forms__field.select." + config.openMenuClass ).removeClass( config.openMenuClass ).removeClass( "active" );
       }
   });
   
   $( ".round-forms__field.select, .round-forms__field.input, .round-forms__field.textarea, .round-forms__field.upload" ).roundForms();
